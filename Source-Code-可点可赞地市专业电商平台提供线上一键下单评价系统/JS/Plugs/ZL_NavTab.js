(function ($) {
    $.fn.ZL_NavTab = function (option) {
        var tlphtml = "<ul class='nav nav-tabs' id='@rid_navtabs_ul'>@li</ul>"
                    + "<a id='@rid_hid_right' class='hid_right'><i class='glyphicon glyphicon-menu-left'></i></a>"
                    + "<a id='@rid_hid_left' class='hid_left'><i class='glyphicon glyphicon-menu-right'></i></a>";;
        var defconfig = {
            hid: "",//存放数据的hidden
            curid: 0,//当前选中项id
