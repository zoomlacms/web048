<%@ page language="C#" autoeventwireup="true" inherits="Common_Ppc, App_Web_3r3em54w" masterpagefile="~/Common/Master/Empty.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<script src="http://code.zoomla.cn/four.js"></script>
<select id="tbProvince" class="form-control text_200_auto"></select>
<select id="tbCity" class="form-control text_200_auto"></select>
<select id="tbCounty" class="form-control text_200_auto"></select>
