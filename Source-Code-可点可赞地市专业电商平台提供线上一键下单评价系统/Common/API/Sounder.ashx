<%@ WebHandler Language="C#" Class="Sounder" %>
...
public class ZL_API_Sound
{
    ...
    private static HttpWebResponse ProcessRequest(string url, string data, string Method = "POST")
    {
        ...
        client.Headers.Add("Origin", "http://demo.zoomla.cn");
        client.Headers.Add("Pragma", "no-cache");
        client.Referer = "http://demo.zoomla.cn/test/test2.aspx";
        ...
        //client.Host = "demo.zoomla.cn";

        //CookieContainer cookie = new CookieContainer();
        //cookie.Add(new Cookie("ASP.NET_SessionId", "hlup5bm0wlcmhojvyctyn4hw", "/", "demo.zoomla.cn"));
