<%@ page language="C#" autoeventwireup="true" inherits="Common_Dialog_SelGroup, App_Web_czsdyt55" masterpagefile="~/Common/Common.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<asp:Content runat="server" ContentPlaceHolderID="head">
<title>选择部门</title>
<style>
    .search_div{position:relative;}
    .search_div .fa-search{position:absolute;right:25px;font-size:1.2em;line-height:34px;color:#999;}
...
<asp:Content runat="server" ContentPlaceHolderID="Script">
    ...
    <script>
        var B_Users = {
            ...
            LoadSelList:function(){//加载已选择用户
                ...
                var html = "<div class=\"userlist_item\" data-uid='@UserID'>"
                        + "<div class=\"item_face pull-left\"><img src=\"@salt\" onerror=\"this.src='/images/userface/noface.gif';\"/></div>"
            ...
            LoadMore: function () {
                ...
                url += "source=<%=Source %>&skey=" + ref.conf.skey + "&psize=" + ref.conf.psize + "&PIndex=" + ref.conf.page + "&groupid=" + ref.conf.groupid + "&char=" + ref.conf.char;
        ...
        //确定选择
        function SelUser() {
            parent.UserFunc(B_Users.sellist, getParam2());
            if ("<%:Source%>" == "plat") {//plat支持群组At
