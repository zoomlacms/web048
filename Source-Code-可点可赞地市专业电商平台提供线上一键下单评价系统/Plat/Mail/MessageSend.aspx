<%@ page language="C#" autoeventwireup="true" inherits="ZoomLa.WebSite.User.MessageSend, App_Web_d34dfpdt" validaterequest="false" clientidmode="Static" masterpagefile="~/Plat/Main.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
  ...
  <table class="table table-border table-hover">
	...
	<tr>
	  ...
	  <td colspan="7"><table class="table table-bordered" id="attachTB">
		  <tr>
			<td style="width:20%"><%--<input type="file" runat="server" name="fileUPs"/>--%><ZL:FileUpload  runat="server" name="fileUPs"/></td>
...
<script type="text/javascript">
    ...
    var uptr = '<tr><td style="width:20%"><ZL:FileUpload  runat="server" name="fileUPs"/></td><td><input type="button" class="btn btn-primary pull-left" value="删除" onclick="delAttach(this);" /></td></tr>';
function addAttach() {
