<%@ page language="C#" autoeventwireup="true" inherits="Plat_RegisterDetail, App_Web_5q1skb5k" masterpagefile="~/Plat/Main.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
$(function () {
    $("#top_nav_ul li[title='资料']").addClass("active");
    $("#prefile_img").hide();
})
</script>
</asp:Content>