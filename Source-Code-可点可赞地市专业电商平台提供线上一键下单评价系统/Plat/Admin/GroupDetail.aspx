<%@ page language="C#" autoeventwireup="true" inherits="Plat_Admin_GroupDetail, App_Web_llszzyf3" masterpagefile="~/Plat/Main.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
$(function () {
    ...
    $(".nav-tabs li:eq(<%:MType%>)").addClass("active");
});
