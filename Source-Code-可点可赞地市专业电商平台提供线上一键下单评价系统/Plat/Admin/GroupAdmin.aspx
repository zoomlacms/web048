<%@ page language="C#" autoeventwireup="true" inherits="Plat_Admin_GroupAdmin, App_Web_psphtiah" masterpagefile="~/Plat/Main.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
    ...
    <ZL:ExGridView runat="server" ID="EGV" AutoGenerateColumns="false" AllowPaging="true" PageSize="10" EnableTheming="False" IsHoldState="false"
      ...
      <asp:TemplateField HeaderText="操作">
        <ItemTemplate> <a href="GroupDetail.aspx?ID=<%#Eval("ID") %>" title="修改信息">修改</a> |
          <asp:LinkButton runat="server" CommandArgument='<%#Eval("ID") %>' OnClientClick="return confirm('是否确认删除!')" CommandName="Del2">删除</asp:LinkButton>
        </ItemTemplate>
      </asp:TemplateField>
      </Columns>
