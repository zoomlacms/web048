<%@ page language="C#" autoeventwireup="true" inherits="test_MailConfig, App_Web_c1tbwc1q" masterpagefile="~/Plat/Main.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<asp:Content runat="server" ContentPlaceHolderID="Content">
    ...
    <div id="configdiv" style="display:none;">
        ...
        <table class="table table-bordered">
            <tr><td>名称</td><td><asp:TextBox runat="server" ID="Alias_T" CssClass="form-control text_300" MaxLength="20" />(20个字符内)</td></tr>
            <tr><td style="width:120px;">邮箱POP</td><td>
               <asp:TextBox runat="server" ID="POP_T" class="form-control text_300" />
            ...
            <tr><td>邮箱帐户</td><td><asp:TextBox runat="server" ID="Acount_T" CssClass="form-control text_300" /></td></tr>
            <tr><td>邮箱密码</td><td><asp:TextBox runat="server" ID="Passwd_T" TextMode="Password" CssClass="form-control text_300"/></td></tr>
            <tr><td>天数</td><td><asp:TextBox runat="server" ID="Days_T" CssClass="form-control text_300"/>(接收多少天内的邮件)</td></tr>
...
<asp:Content runat="server" ContentPlaceHolderID="ScriptContent">
    ...
    <script type="text/javascript">
        $(function () {
            $("#top_nav_ul li[title='邮件']").addClass("active");
        })
        function BindEvent() {
