<%@ page language="C#" autoeventwireup="true" inherits="ZoomLa.WebSite.User.MessageSend, App_Web_zoh4bpj2" validaterequest="false" clientidmode="Static" masterpagefile="~/User/Empty.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<table class="table_li table-border" style="width: 100%;">
    <tr>
        ...
        <td class="tdRight">
        <asp:TextBox CssClass="form-control text_300" ID="TxtInceptUser" runat="server" style="margin-right:10px;" />
    ...
    <tr>
        ...
        <td class="tdRight">
        <asp:TextBox CssClass="form-control text_300" ID="ccUserT" runat="server" style="margin-right:10px;"/>
