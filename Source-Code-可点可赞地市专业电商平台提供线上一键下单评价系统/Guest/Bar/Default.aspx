<%@ page language="C#" autoeventwireup="true" inherits="Guest_Bar_BarList, App_Web_tjh5ddgo" masterpagefile="~/Guest/Guest.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
    ...
    <ItemTemplate>
            <h5 class="well well-sm margin_bottom0"><a href="/PClass?id=<%#Eval("CateID") %>"><%#Eval("CateName") %></a></h5>
             <asp:Repeater runat="server" ID="ChildRPT" EnableViewState="false">
                    ...
                    <ItemTemplate>
                        <tr>
                            <td class="club_div_img"><a href="/PClass?id=<%#Eval("CateID") %>" title="<%#Eval("CateName") %>"><img src="<%#Eval("BarImage") %>" onerror="this.src='/Images/nopic.gif';" alt="<%#Eval("CateName") %>" /></a></td>
                            <td class="cateName">
