<%@ page language="C#" autoeventwireup="true" inherits="Guest_Bar_PostList, App_Web_tjh5ddgo" masterpagefile="~/Guest/Guest.master" validaterequest="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
        ...
        <ItemTemplate>
            <div class="tie_list">
                ...
                <div class="font12 tie_rel_count">
                    <div><span class="glyphicon glyphicon-user"></span><a href="<%#"PostSearch?uid="+Eval("CUser") %>"><%# GetUName()%></a></div>
                    <div><%#GetRUser() %></div>
                </div>
                <div class="clearboth"></div>
            </div>
