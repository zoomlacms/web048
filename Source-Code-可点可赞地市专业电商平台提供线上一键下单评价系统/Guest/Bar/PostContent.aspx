<%@ page language="C#" autoeventwireup="true" inherits="Guest_Bar_PostContent, App_Web_tjh5ddgo" masterpagefile="~/Guest/Guest.master" validaterequest="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
                ...
                <ItemTemplate>
                    <div class="msgmain_div stickem-container" id="msgmain_div_<%#Eval("ID") %>">
                        <div class="msg_left_div padding0 col-lg-2 col-md-2 col-sm-2 col-xs-2">
                            <div class="stickem">
                                <a <%#GetHref() %>>
                                    <img class="imgface_mid center-block" src='<%#GetUserFace() %>' data-uid="<%#Eval("CUser") %>" onerror="this.src='/Images/userface/noface.gif';" /></a>
                                ...
                                <div class="msg_rel_div">
                                    ...
                                    <div class="msg_rel_main">
                                        <div class="col-md-4 col-xs-5 padding5">
                                            <a <%#GetHref() %>>
                                                <img class="img-responsive center-block" src='<%#GetUserFace() %>' onerror="this.src='/Images/userface/noface.gif';" /></a>
                                        </div>
                                ...
                                <div id="like_div_<%#Eval("ID") %>">
                                    <ul class="likeids_div_ul">
                                        ...
                                        <li style="width: auto;"><a href="javascript:;" onclick="OPLike(<%#Eval("ID") %>);" class="likeids_div_a">
                                            <i class="glyphicon glyphicon-thumbs-up"></i><span class="likenum_span likenum_text">(<%#GetLikeNum() %>)</span></a>
                                        </li>
                                        <%#ShowLikeUser() %>
                                    </ul>
                                </div>
...
<div id="metals_div">
    <div class="panel panel-default">
      <div class="panel-heading">
        <h3 class="panel-title"><span id="metals_title"></span> <span class="pull-right" style="cursor:pointer;" onclick="$('#metals_div').hide();"><i class="glyphicon glyphicon-remove"></i></span></h3>
      </div>
...
<script type="text/javascript">
    ...
    LikeComp.liTlp = '<li title="@UserName" class="likeids_li" data-uid="@UserID"><a href="javascript:;"><img src="@UserFace" onerror=\"this.src=\'/Images/UserFace/noface.gif\'"></a></li>';
    //贴子ID
