<%@ page language="C#" autoeventwireup="true" validaterequest="false" inherits="BBS_GuestShow, App_Web_2j5ndc2w" enableviewstatemac="false" masterpagefile="~/Common/Master/Empty.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
                    ...
                    <table class="table table-bordered">
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <input type="hidden" id="VCode_hid" name="VCode_hid" /><span id="sp1"></span></td>
                        </tr>
                        <tr>
                            <td colspan="2" align="center">
                                <asp:Button ID="EBtnSubmit2" runat="server" CssClass="btn btn-primary i_bottom" OnClick="EBtnSubmit_Click" Style="margin-top: 10px; display: none;" />
                                <a href="javascript:;" onclick="ebtn_click();" class="btn btn-success  btn-lg"><i class="fa fa-pencil"></i>发表回复</a>
                            </td>
                        </tr>
                    </table>
                </div>
