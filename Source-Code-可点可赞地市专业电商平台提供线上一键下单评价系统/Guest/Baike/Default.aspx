<%@ page language="C#" autoeventwireup="true" masterpagefile="~/Guest/Baike/Baike.master" clientidmode="Static" inherits="Guestbook_BkSearch, App_Web_2ixvp1rg" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<div class="col-lg-3 col-md-3 col-sm-3 col-xs-12 padding2">
    <a href="/Baike/Search.aspx?UserID=<%#Eval("UserID") %>" target="_blank"><img src="<%#Eval("UserFace") %>" onerror="javascript:this.src='/Images/userface/noface.gif';" alt="<%#Eval("UserName") %>" /></a>
</div>
