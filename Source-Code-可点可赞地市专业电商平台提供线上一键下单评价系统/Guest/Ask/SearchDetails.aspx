<%@ page language="C#" autoeventwireup="true" masterpagefile="~/Guest/Ask/Ask.master" inherits="Guest_SearchDetails, App_Web_ehwxb5qz" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<div class="ask_Resolved_t"><i class="glyphicon glyphicon-tags"></i> 期待您回答：<span class="pull-right"><i class="fa fa-heart"></i>我们向您承诺：10分钟内给您满意的答复</span></div>
