<%@ page language="C#" autoeventwireup="true" inherits="Guestbook_Ask, App_Web_ehwxb5qz" masterpagefile="~/Guest/Ask/Ask.master" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<ItemTemplate>
<img align="absmiddle" src="/App_Themes/Guest/images/num1.gif" id="ph" runat="server"> <a href="/ShowList.aspx?id=<%#Eval("UserID") %>"><%#Eval("UserName") %></a></span><img align="absmiddle" src="/App_Themes/Guest/images/up.gif"><%#Eval("GuestScore") %>
</ItemTemplate>
</asp:Repeater>
</div>
<div>
