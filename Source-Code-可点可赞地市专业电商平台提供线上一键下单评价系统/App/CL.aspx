<%@ page language="C#" autoeventwireup="true" inherits="App_CreateLink, App_Web_tilvcd0p" masterpagefile="~/Manage/I/Default.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<div class="col-md-7 col-lg-7" style="padding-left:0px;">
    ...
    <tr><td colspan="2" class="text-center"><strong>智能设备识别</strong></td></tr>
        <tr><td>应用名称：</td><td><asp:TextBox runat="server" ID="Alias_T" CssClass="form-control text_300" /></td></tr>
