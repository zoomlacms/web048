<%@ page language="C#" autoeventwireup="true" inherits="Plat_PreView, App_Web_x55yxtr4" enableviewstate="false" masterpagefile="~/Common/Master/Empty.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<asp:Content runat="server" ContentPlaceHolderID="Content">
    ...
    <%--    <div runat="server" id="pdfDiv" visible="false">
        ...
        <div runat="server" id="pdfDiv" visible="false">
            <iframe src="/Plugins/PDFView/web/viewer.html?pdf=<%=vpath %>" style="width:100%;border:none;height:600px;"></iframe>
        </div>
