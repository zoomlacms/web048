<%@ page language="C#" autoeventwireup="true" inherits="Design_User_Content_List, App_Web_jpus3fa1" masterpagefile="~/Design/Master/User.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="操作" HeaderStyle-CssClass="td_l">
                            <ItemTemplate>
                                ...
                                <a href="AddContent.aspx?GeneralID=<%#Eval("GeneralID")+"&SiteID="+SiteID %>" class="option_style" title="修改"><i class="glyphicon glyphicon-pencil"></i></a>
