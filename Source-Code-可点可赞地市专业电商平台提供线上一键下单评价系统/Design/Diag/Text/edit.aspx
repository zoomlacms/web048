<%@ page language="C#" autoeventwireup="true" inherits="Design_Diag_Text_edit, App_Web_co3i1bnc" masterpagefile="~/Design/Master/Edit.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<asp:Content runat="server" ContentPlaceHolderID="Script">
    <script>
        $(function () {
			...
			//文本值
            $("#content_t").text(editor.model.dataMod.text);
            //绑定事件,字体,颜色,位置,缩进
