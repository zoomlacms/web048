<%@ page language="C#" autoeventwireup="true" inherits="Design_Diag_div_edit, App_Web_p1k4lgl1" masterpagefile="~/Design/Master/Edit.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
                ...
                <div class="setting-row">
                    ...
                    <table class="table table-bordered table-striped">
                        ...
                        <tr ng-repeat="item in model.dataMod.links">
                            ...
                            <td><a href="javascript:;" ng-click="dellink(item);"><i class="glyphicon glyphicon-remove"></i></a></td>
                        </tr>
                    </table>
