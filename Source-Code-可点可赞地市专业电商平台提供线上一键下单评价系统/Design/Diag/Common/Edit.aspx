<%@ page language="C#" autoeventwireup="true" inherits="Design_Diag_Common_Edit, App_Web_i33hq4wy" masterpagefile="~/Design/Master/Edit.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<asp:Content runat="server" ContentPlaceHolderID="Content">
    ...
    <div class="tab-content">
        <div role="tabpanel" class="tab-pane active" id="home">
            ...
            <div class="setting-row">
                <div>
                    <label class="row-title">字体颜色</label></div>
            ...
            <div class="setting-row" data-group="indent">
                <div>
                    <label class="row-title">定位</label></div>
                <div class="pos_div">
...
<asp:Content runat="server" ContentPlaceHolderID="Script">
    ...
    <script>
        ...
        $(function () {
            ...
            $("#opacity_t").val((1 - editor.dom.css("opacity")) * 100 + "%");
            ...
            $("#opacity_slider").slider({
                range: "min", min: 1, max: 100, value: (1 - editor.dom.css("opacity")) * 100,
                slide: function (event, ui) {
