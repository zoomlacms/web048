<%@ page language="C#" autoeventwireup="true" inherits="Design_Diag_AddComp, App_Web_cbvi0t01" masterpagefile="~/Common/Master/Empty.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<asp:Content runat="server" ContentPlaceHolderID="Content">
    ...
    <ul class="category-list"  style="min-height:515px;position:fixed;left:0px;">
        ...
        <div id="uedior_div" class="category-view-wrapper" style="display:none;">
            <textarea id="content_t" style="height:400px;"></textarea>
