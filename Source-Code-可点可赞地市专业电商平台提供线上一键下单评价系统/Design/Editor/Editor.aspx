<%@ page language="C#" autoeventwireup="true" inherits="Design_Editor_Editor, App_Web_fy0fh2em" enableviewstate="false" enableEventValidation="false" viewStateEncryptionMode="Never" %><!DOCTYPE html>
...
<body>
   ...
   <%--             <li data-cmd="cut"><a><i class="fa fa-cut"></i> 剪切</a></li>
        ...
        <script>
            ...
            var domFilter = ".onlyresize,.candrag,.onlydrag,.dragy";//所有组件元素
            ...
            function EventBind() {
                ...
                $(".candrag,.onlydrag").draggable({
                    scroll: true,
                    iframeFix: true,
                    start: function (e, ui) { alignLine.domHeight = $(window).height() + $(window).scrollTop(); alignLine.width = $(e.target).width(); alignLine.height = $(e.target).height() },
                    drag: function (e, ui) {
                    ...
                    stop: function (e, ui) { $('.drag_alignLine').css("display", "none"); }
                });
                ...
                $(".candrag,.onlyresize").resizable({
                    ...
                    start: function (event, ui) { $('#compinfo_div').show(); },
                    stop: function (event, ui) { $('#compinfo_div').hide(); }
                });
