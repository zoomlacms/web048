define(function (require, exports, module) {
   ...
   + '</div>'//item end;
   + '</div>'
   + '<a class="carousel-control left" href="#@id" data-slide="prev"><span class="glyphicon glyphicon-chevron-left" style="font-size:3em;"></span></a>'
   + '<a class="carousel-control right" href="#@id" data-slide="next"><span class="glyphicon glyphicon-chevron-right" style="font-size:3em;"></span></a></div>';
