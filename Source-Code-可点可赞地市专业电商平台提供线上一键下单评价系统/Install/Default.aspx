<%@ page language="C#" autoeventwireup="true" inherits="Install_Default, App_Web_jwzenql5" responseencoding="utf-8" clientidmode="Static" enableEventValidation="false" viewStateEncryptionMode="Never" %><!DOCTYPE html>
...
.instside{ margin-top:1em;}/*five points below the page*/ 
...
.content_body {margin-top:35px;}
.div300 {display:inline-block;width:300px;max-width:300px;}
.control-label {color:#fff;line-height:34px;min-width:90px;display:inline-block;}
.insbox_txt {color:#fff;}
.small_txt {color:#fff;margin-left:5px;}
...
.name_tips{color:#fff;font-size:18px;}
.insok { padding-top:8em;}
...
#carousel_step div {text-overflow:ellipsis;overflow:hidden; white-space:nowrap; }
</style>
</head><body>
    ...
    <div class="navbar navbar-fixed-top" role="navigation">
        ...
        <div class="user_mimenu_left">
            <ul class="list-unstyled">
                ...
                <li><a href="http://help.zoomla.cn" target="_blank"><%=Resources.L.使用手册 %></a></li>
                <li><a href="http://www.zoomla.cn/mtv" target="_blank"><%=Resources.L.视频教程 %></a></li>
                <li><a href="http://help.zoomla.cn/Database" target="_blank"><%=Resources.L.数据字典 %></a></li>
                <li><a href="http://www.zoomla.cn/shop" target="_blank"><%=Resources.L.商业授权 %></a></li>
                <li><a href="http://www.zoomla.cn/corp" target="_blank"><%=Resources.L.关于逐浪 %></a></li>
                <li><a href="http://www.zoomla.cn/y10" target="_blank"><%=Resources.L.十年辉煌 %></a></li>
            </ul>
        </div>
    ...
    <div class="container content_body text-left" style="max-width: 700px;">
        ...
        <div class="form-group">
            ...
            <span class="control-label text-center">
                <label><input type="checkbox" runat="server" id="ignoreSql_chk" /> <%=Resources.L.重置安装 %></label>
            </span>
...
<div class="container-fulid instcon">
    ...
    <div class="container text-left content_body" style="max-width: 740px; padding-left:160px;">
        ...
        <div class="form-group">
            ...
            <a class="name_tips" href="javascript:;" data-toggle="popover" data-content="<%=Resources.L.如库中已有此管理员 %>."><span class="glyphicon glyphicon-info-sign"></span></a> 
            <span class="control-label"></span>
        </div>
        <div class="form-group">
            ...
            <a class="name_tips" href="javascript:;" data-toggle="popover" data-content="<%=Resources.L.不少于6位字母数字组合 %>" tabindex="-1"><span class="glyphicon glyphicon-info-sign"></span></a> 
            <span class="control-label">
        ...
        <div class="form-group">
            ...
            <a class="name_tips" href="javascript:;" tabindex="-1" data-toggle="popover" data-content="<%=Resources.L.安装完成后可在后台进行配置 %>"><span class="glyphicon glyphicon-info-sign"></span></a> 
            <span class="control-label">
        ...
        <div class="form-group">
            ...
            <a class="name_tips" href="javascript:;" tabindex="-1" data-toggle="popover" data-content="<%=Resources.L.初始为不开通管理认证码功能 %>"><span class="glyphicon glyphicon-info-sign"></span></a> 
            <span class="control-label">
...
<div class="container-fulid instcon">
    ...
    <div class="container content_body">
        <div class="control-label insok">
              <h2><a class="btn btn-primary btn-lg" href="/Default.aspx"><i class="fa fa-check"></i><%=Resources.L.已经成功安装点此进入首页 %></a><br/><span><%=Resources.L.重装请新定义配置文件 %></span>
			  </h2>
 </div>
        </div>
    </div>
...
<div class="container instside">
    <ul id="carousel_step" class="list-unstyled">
        <li data-slide-to="1"><div class="step_circle"></div><div><%=Resources.L.安装协议 %></div></li>
        <li data-slide-to="2"><div class="step_circle"></div><div><%=Resources.L.数据连接 %></div></li>
        <li data-slide-to="3"><div class="step_circle"></div><div><%=Resources.L.环境检测 %></div></li>
        <li data-slide-to="4"><div class="step_circle"></div><div><%=Resources.L.配置信息 %></div></li>
        <li data-slide-to="5"><div class="step_circle"></div><div><%=Resources.L.完成安装 %></div></li>
    </ul>
</div> 
</div>
