<%@ page language="C#" autoeventwireup="true" inherits="test_doc, App_Web_hxphqoha" enableEventValidation="false" viewStateEncryptionMode="Never" %><!DOCTYPE html>
                ...
                if ($docBody != null) {
                    ...
                    $docBody.find(".doc_cursor").each(function () {
                        ...
                        var html = "<span class=\"Sf-zg-Ie\" style=\"opacity: 0.83; background-color: rgb(230, 104, 91);\">"
                            ...
                            + "<img style=\"width: 100%; height: 100%;\" src=\"" + $ref.data("face") + "\" onerror=\"this.src='/Images/userface/noface.gif';\";>"
                            + "</span>"
