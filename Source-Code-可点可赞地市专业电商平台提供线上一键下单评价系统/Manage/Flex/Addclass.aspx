<%@ page language="C#" autoeventwireup="true" inherits="manage_Flex_Addclass, App_Web_dof0p5hd" enableviewstatemac="false" masterpagefile="~/Manage/I/Default.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<table class="table table-striped table-bordered table-hover">
	...
	<tr>
		<td class="td_l tdleft"><strong>分类名称：</strong></td>
		<td style="text-align: left;">
			<asp:TextBox ID="classname" class="form-control" runat="server" Width="300px"></asp:TextBox>
		</td>
	</tr>
	<tr>
		<td class="tdleft"><strong>分类排序：</strong>
            <br />(数字越大排列越前)
		</td>
		<td style="text-align: left;">
	...
	<tr>
		<td class="tdleft"><strong>所属产品：</strong>
		</td>
		<td style="text-align: left;">
			<asp:DropDownList ID="cl_PClass" CssClass="form-control text_300" runat="server"></asp:DropDownList>
	...
	<tr>
		<td class="tdleft"><strong>模板规格：</strong>
		</td>
		<td style="text-align: left;">
	...
	<tr id="Encrypt" runat="server">
		<td class="tdleft"><strong>选择排版：</strong>
		</td>
		<td style="text-align: left;">
