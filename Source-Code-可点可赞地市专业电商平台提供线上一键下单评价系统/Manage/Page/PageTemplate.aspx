<%@ page language="C#" autoeventwireup="true" inherits="manage.Page.PageTemplate, App_Web_mofs213c" enableviewstatemac="false" masterpagefile="~/Manage/I/Default.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
    ...
    <asp:Label ID="addtree" runat="server" Visible="false"></asp:Label>
        <table  class="table table-striped table-bordered table-hover">
            <tbody id="Tbody1">
                ...
                <tr>
                    <td>0</td>
                    <td><a href="javascrip:;"><span class="glyphicon glyphicon-folder-open"></span><span><asp:Label runat="server" ID="StyleName_L" /></span></a></td>
                            ...
                            case 1:
                                if (state == "0") {
                                    if ($("tr:nth-child(" + i + ")").attr("name") != "list0") {
                                        $("tr:nth-child(" + i + ")").css("display", "none");
                                        $("tr:nth-child(" + i + ")").attr("state", "0");
                                        $(obj).find('.glyphicon').attr('class', 'glyphicon glyphicon-folder-close')
                                    }
                                }
                                else {
                                    $(".list" + sid).css("display", "");
                                    $("tr:nth-child(" + i + ")").attr("state", "1");
                                    $(obj).find('.glyphicon').attr('class', 'glyphicon glyphicon-folder-open')
                                }
                                break;
                        }
                    }
