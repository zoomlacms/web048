<%@ page language="C#" autoeventwireup="true" inherits="Zoomla.WebSite.Manage.Page.UserModelManage, App_Web_mofs213c" enableviewstatemac="false" masterpagefile="~/Manage/I/Default.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
            ...
            <ItemTemplate>
                <tr class="tdbg" align="center"  id="<%# Eval("ModelID") %>" ondblclick="getinfo(this.id)">                        
                    ...
                    <td>
                        ...
                        <asp:LinkButton ID="LinkButton3" class="option_style" runat="server" CommandName="Field" ToolTip="字段列表" CommandArgument='<%# Eval("ModelID") %>'><i class="glyphicon glyphicon-th-list" title="字段列表"></i>字段列表</asp:LinkButton> 
                        </td>
                </tr>
            </ItemTemplate>
         </asp:Repeater>                        
