<%@ page language="C#" autoeventwireup="true" inherits="manage.Page.PageStyle, App_Web_mofs213c" enableviewstatemac="false" masterpagefile="~/Manage/I/Default.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
        ...
        <Columns>
            ...
            <asp:TemplateField HeaderText="相关操作">
                <ItemTemplate>
                    ...
                    <a href="?menu=del&id=<%#Eval("PageNodeid") %>" class="option_style" onclick="return confirm('确实删除此黄页样式? 删除该样式后前台黄页将无法使用该样式!');"><i class="glyphicon glyphicon-trash" title="删除"></i></a>
                    <a href="PageTemplate.aspx?styleid=<%#Eval("PageNodeid") %>" title="栏目管理" class="option_style"><i class="glyphicon glyphicon-th-list" title="栏目管理"></i>栏目管理</a>
                </ItemTemplate>
            </asp:TemplateField>
        </Columns>
    </ZL:ExGridView>
