<%@ page language="C#" autoeventwireup="true" inherits="ZoomLa.WebSite.Manage.Page.PageContent, App_Web_mofs213c" enableviewstatemac="false" masterpagefile="~/Manage/I/Default.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <asp:LinkButton ID="LinkButton2" runat="server" ToolTip="修改" CommandName="Edit" CssClass="option_style" CommandArgument='<%# Eval("GeneralID") %>'><i class="glyphicon glyphicon-pencil" title="修改"></i></asp:LinkButton>
                             <asp:LinkButton ID="LinkButton3" runat="server" CssClass="option_style" CommandName="Del" CommandArgument='<%# Eval("GeneralID") %>' OnClientClick="return confirm('确定将该数据删除到回收站?')"><i class="glyphicon glyphicon-trash" title="删除"></i> 删除</asp:LinkButton>
                        </td>
                    </tr>
                </ItemTemplate>
