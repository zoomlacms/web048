<%@ page language="C#" autoeventwireup="true" inherits="manage_Question_Papers_System_Manage, App_Web_sganzmbg" enableviewstatemac="false" masterpagefile="~/Manage/I/Default.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
         ...
         CssClass="table table-striped table-bordered table-hover" EnableTheming="False"
            ...
            <Columns>
                ...
                <asp:TemplateField HeaderText="操作">
                    <ItemTemplate>
                        <a href="Add_Papers_System.aspx?paper_id=<%#Eval("id") %>" class="option_style">修改试卷</a>
