<%@ page language="C#" autoeventwireup="true" masterpagefile="~/Manage/I/Default.master" inherits="Manage_I_Exam_PublishDesc, App_Web_1uksd101" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<ZL:ExGridView runat="server" ID="EGV" AutoGenerateColumns="false" AllowPaging="true" PageSize="10"  EnableTheming="False" 
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="操作">
                        <ItemTemplate>
                            <a href="/Rss/News/ViewPublish.aspx?Pid=<%#Eval("ID") %>" target="_blank" title="前台浏览" class="option_style"><i class="fa fa-globe" title="浏览"></i></a><span class="sperspan"></span>
