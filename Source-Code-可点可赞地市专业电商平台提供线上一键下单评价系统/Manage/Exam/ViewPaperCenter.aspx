<%@ page language="C#" autoeventwireup="true" inherits="Manage_Exam_ViewPaperCenter, App_Web_sganzmbg" masterpagefile="~/Manage/I/Default.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<table class="table table-bordered table-striped table-hover">
    ...
    <tr><td>操作:</td><td>
        <a href="Add_Papers_System.aspx?paper_id=<%:PaperID %>" class="btn btn-info" target="_blank">修改试卷</a>
								...
								<div class="item" data-id="<%#Eval("p_id") %>" id="item_<%#Eval("p_id") %>">
									<div class="content">
										<div class="opdiv alert-info">
											...
											<a href="AddEngLishQuestion.aspx?p_id=<%#Eval("p_id") %>" target="_blank">修改试题</a>
