<%@ page language="C#" debug="true" autoeventwireup="true" inherits="manage_UserShopManage_StoreManage, App_Web_ua3yxpvt" validaterequest="false" enableviewstatemac="false" masterpagefile="~/Manage/I/Default.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
            ...
            <Columns>
                ...
                <asp:TemplateField HeaderText="操作">
                    <ItemTemplate>
                        ...
                        <a target="_blank" href="/Store/StoreIndex.aspx?id=<%#Eval("GeneralID") %>" class="option_style"><i class='fa fa-globe' title="浏览"></i>浏览</a>                               
                    </ItemTemplate>
                </asp:TemplateField>
            </Columns>
        </ZL:ExGridView>
