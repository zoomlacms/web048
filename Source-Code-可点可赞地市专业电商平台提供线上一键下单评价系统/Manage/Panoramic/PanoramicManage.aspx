<%@ page language="C#" autoeventwireup="true" inherits="manage_Panoramic_PanoramicManage, App_Web_yk5ko3g4" enableviewstatemac="false" masterpagefile="~/Manage/I/Default.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
        ...
        <Columns>
            ...
            <asp:TemplateField HeaderText="操作">
               <HeaderStyle Width="15%" />
                <ItemTemplate>
                    <a href="javascript:void(0);" data-toggle="modal" data-target="#Panoramic_div" onclick="Open_Select(<%#Eval("ID") %>)"><i class="fa fa-eye" title="预览"></i></a>
                    <a href="AddPanoramic.aspx?menu=edit&id=<%#Eval("ID") %>" class="option_style"><i class="fa fa-pencil" title="修改"></i></a>
                    <asp:LinkButton ID="LinkButton1" CommandName="del" CommandArgument='<%# Eval("ID") %>' runat="server" OnClientClick="return confirm('确实要删除吗？删除后该信息无法恢复!');" CssClass="option_style"><i class="fa fa-trash-o" title="删除"></i>删除</asp:LinkButton>
                </ItemTemplate>
            </asp:TemplateField>
        </Columns>
    </ZL:ExGridView>
