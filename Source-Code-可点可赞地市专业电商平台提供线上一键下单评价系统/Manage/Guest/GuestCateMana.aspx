<%@ page language="C#" masterpagefile="~/Manage/I/Default.master" autoeventwireup="true" inherits="Manage_I_Guest_GuestCateMana, App_Web_iglwujjl" validaterequest="false" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
    ...
    <asp:Repeater runat="server" ID="RPT">
        ...
        <ItemTemplate>
            <tr data-layer="1" data-id="<%#Eval("CateID") %>" data-pid="0"  onclick="ShowChild(this,<%#Eval("CateID") %>);" ondblclick="ToggleChild(this);">
                ...
                <td style="text-align:left;"><a href="TieList.aspx?CateID="+<%#Eval("CateID") %>"><span data-type="icon" class="<%#Convert.ToInt32(Eval("ChildCount"))>0?"glyphicon glyphicon-folder-close rep_tree_icon":"glyphicon glyphicon-file rep_tree_icon" %>" /></span></a><%#GetCateName()%></td>
