<%@ page language="C#" autoeventwireup="true" inherits="manage_Counter_Month, App_Web_eoh53djd" enableviewstatemac="false" masterpagefile="~/Manage/I/Default.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<asp:Content runat="server" ContentPlaceHolderID="head">
    <title>日统计报表</title><style>.allchk_l{display:none;}</style>
</asp:Content>
