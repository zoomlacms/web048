<%@ page language="C#" masterpagefile="~/Manage/I/Default.master" autoeventwireup="true" inherits="Manage_I_Pub_PubManage, App_Web_13f3zjgq" clientidmode="Static" validaterequest="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
            ...
            <Columns>
                ...
                <asp:TemplateField HeaderText="<%$Resources:L,操作 %>">
                    <ItemTemplate>
                        ...
                        <asp:LinkButton runat="server" CssClass="option_style" OnClientClick="return confirm('是否删除该项!')" CommandName="Del" CommandArgument='<%#Eval("PubID") %>'><i class="glyphicon glyphicon-trash"></i><%=Resources.L.删除 %></asp:LinkButton>
                    </ItemTemplate>
                </asp:TemplateField>
            </Columns>
