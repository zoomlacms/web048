<%@ page language="C#" autoeventwireup="true" inherits="manage_Site_AdminLogin, App_Web_zphktkpw" masterpagefile="~/Manage/I/Default.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
                ...
                <table class="site_border tab-content">
                    <tbody id="tabBody0" class="tabBody tab-pane active">
                        <tr>
                            ...
                            <td>
                                <asp:TextBox runat="server" ID="adminName" autocomplete="off" CssClass="form-control text_300" /></td>
                        </tr>
                        <tr>
...
4、如有问题请访问<a href="http://bbs.zoomla.cn" target="_blank">bbs.zoomla.cn</a>开发专区交流，官方微博<a href="http://weibo.com/zoomlacms" target="_blank">http://weibo.com/zoomlacms</a>。<br/>
