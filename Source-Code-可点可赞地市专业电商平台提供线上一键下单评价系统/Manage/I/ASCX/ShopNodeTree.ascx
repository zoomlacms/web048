<%@ control language="C#" autoeventwireup="true" inherits="Manage_I_ASCX_ShopNodeTree, App_Web_0t4onaoj" clientidmode="Static" %>
<div class="menu_tit"><span class="fa fa-chevron-down"></span> 商品管理</div>
<div id="nodeNav" style="padding:0;">
<div class="input-group">
<input type="text" ID="keyWord" class="form-control ascx_key" onkeydown="return ASCX.OnEnterSearch('<%:CustomerPageAction.customPath2+"Shop/ProductManage.aspx?souchtype=1&keyWord=" %>',this);" placeholder="<%=Resources.L.商品名称或ID %>" />
