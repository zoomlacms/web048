<%@ control language="C#" autoeventwireup="true" inherits="Manage_I_ASCX_LabelGuide, App_Web_rm5ee03t" %>
...
<div class="tvNavDiv" style="height:auto;">
    <div class="left_ul">
        <ul>
            ...
            <li><a href="javascript:;" onclick="ShowMain('','{$path}Template/DSManage.aspx')"><%=Resources.L.外部数据源 %></a></li>
