<%@ page language="C#" autoeventwireup="true" inherits="Manage_I_Content_LabelSql, App_Web_brtnwmsp" masterpagefile="~/Manage/I/Default.master" validaterequest="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
				  ...
				  <table>
					<tr>
					  <td><table class="table table-striped table-bordered">
						  ...
						  <tr>
							<td style="text-align: right;">输出字段： </td>
					  ...
					  <td><table id="table2" class="table table-striped table-bordered" runat="server">
						  ...
						  <tr>
							<td style="text-align: right;">从表： </td>
