<%@ page language="C#" autoeventwireup="true" inherits="Manage_I_Content_LabelManage, App_Web_brtnwmsp" masterpagefile="~/Manage/I/Default.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<ol id="BreadNav" class="breadcrumb navbar-fixed-top"  style="padding-top:2px; padding-bottom:1px;">
    ...
    <div id="help" class="pull-right text-center"><a href="javascript::" id="sel_btn" class="help_btn"><i class="fa fa-search"></i></a><a onclick="help_show('21')" title="<%=Resources.L.帮助 %>" class="help_btn"><span class="glyphicon glyphicon-question-sign"></span></a></div>
</ol>
</div>
</div>
