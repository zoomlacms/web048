<%@ page language="C#" autoeventwireup="true" inherits="Manage_I_Content_TemplateManage, App_Web_brtnwmsp" masterpagefile="~/Manage/I/Default.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<asp:Content runat="server" ContentPlaceHolderID="Content">
    ...
    <a href="javascript:;" class="btn btn-primary" onclick="ShowDirDiag()"><%=Resources.L.创建目录 %></a>
    <a href="javascript:;" class="btn btn-primary" onclick="SelTempFile()"><%=Resources.L.上传模板 %></a>
    <asp:Button ID="BackGrup" class="btn btn-primary" runat="server" Text="<%$Resources:L,备份当前方案 %>" OnClick="BackGrup_Click" OnClientClick="if(!this.disabled) return confirm('是否创建备份？(提示：备份同名文件会覆盖！)');" />
    <a runat="server" id="ViewEdit_A" class="btn btn-primary" target="_blank"><i class="fa fa-edit" style="margin-right:5px;"></i><%=Resources.L.可视化编辑 %></a>
