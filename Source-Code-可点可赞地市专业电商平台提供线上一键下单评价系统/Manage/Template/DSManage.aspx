<%@ page language="C#" autoeventwireup="true" inherits="Manage_I_Content_DSManage, App_Web_brtnwmsp" masterpagefile="~/Manage/I/Default.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
            ...
            <ZL:ExGridView ID="sgv1" runat="server" DataSourceID="DSData" AllowPaging="True" AutoGenerateColumns="false" IsHoldState="false"
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="操作">
                        <ItemTemplate>
                            <asp:LinkButton ID="Edit" runat="server" CommandName="Edit2" CommandArgument='<%# Container.DisplayIndex %>' CssClass="option_style"><i class="fa fa-pencil" title="修改"></i></asp:LinkButton>
                            <asp:LinkButton runat="server" CommandName="Del" CommandArgument='<%# Eval("ID") %>'
                                OnClientClick="return confirm('确定删除该数据源?');" CssClass="option_style"><i class="fa fa-trash-o" title="删除"></i>删除</asp:LinkButton>
                        </ItemTemplate>
                        <EditItemTemplate>
