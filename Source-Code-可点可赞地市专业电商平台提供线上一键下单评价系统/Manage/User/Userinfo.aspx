<%@ page language="C#" autoeventwireup="true" inherits="manage_User_Userinfo, App_Web_j3oqy1go" enableviewstatemac="false" masterpagefile="~/Manage/I/Default.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<div class="tab-content">
    <div class="tab-pane active" id="Tabs0">
        <table class="table table-striped table-bordered table-hover">
            <tbody>
                <asp:Repeater ID="UInfo_RPT" runat="server" OnItemCommand="Repeater1_ItemCommand">
                    <ItemTemplate>
                        <tr>
                            <td style="width: 15%; height: 25px;" class="text-right">用户名： </td>
                            <td style="width: 35%; height: 25px;">
                                <%#Eval("UserName") %> &nbsp;
                                            <a href="Addon/UserLogin.aspx?uname=<%#HttpUtility.UrlEncode(Eval("UserName",""))+"&upwd="+Eval("UserPwd") %>" target="_blank" class="btn btn-info">作为此会员登录</a>
                                <asp:LinkButton ID="ResetSpwd" OnClick="ResetSpwd_Click" OnClientClick="确定重设?" CssClass="btn btn-info" Text="重设二级密码" runat="server"></asp:LinkButton>
                            </td>
                    ...
                    <ItemTemplate>
                        ...
                        <tr>
                            ...
                            <td style="width: 35%; height: 26px;">
                                <img title="<%#Eval("UserFace") %>" style="width: 40px; height: 40px;" src="<%#Eval("UserFace") %>" onerror="this.src='/Images/userface/noface.gif';" />
                            </td>
                        </tr>
                        <tr>
