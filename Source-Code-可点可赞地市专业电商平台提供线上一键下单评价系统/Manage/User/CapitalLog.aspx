<%@ page language="C#" autoeventwireup="true" masterpagefile="~/Manage/I/Default.master" inherits="Manage_User_CapitalLog, App_Web_j3oqy1go" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<asp:Content runat="server" ContentPlaceHolderID="Content">
    ...
    OnPageIndexChanging="EGV_PageIndexChanging" OnRowDataBound="EGV_RowDataBound" >
        <Columns>
                ...
                <asp:BoundField HeaderText="ExpHisID" DataField="ExpHisID" HeaderStyle-Height="22" />
