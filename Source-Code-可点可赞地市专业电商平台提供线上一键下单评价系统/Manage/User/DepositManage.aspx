<%@ page language="C#" autoeventwireup="true" inherits="Manage_User_DepositManage, App_Web_j3oqy1go" masterpagefile="~/Manage/I/Default.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<asp:Content runat="server" ContentPlaceHolderID="Content">
    ...
    <table class="table table-striped table-bordered table-hover">
        <tr>
            <td></td>
            <td>用户ID</td><td>用户名</td><td>用户组</td><td>出金金额</td><td>申请时间</td>
            <td>帐户信息</td><td>出金状态</td>
