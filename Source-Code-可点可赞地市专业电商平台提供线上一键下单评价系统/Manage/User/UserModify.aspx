<%@ page language="C#" autoeventwireup="true" inherits="ZoomLa.WebSite.Manage.User.UserPassModify, App_Web_j3oqy1go" enableviewstatemac="false" masterpagefile="~/Manage/I/Default.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
        ...
        <div class="tab-pane" id="Tabs3">
            <table class="table table-striped table-bordered table-hover padding0">
                <tr>
                    ...
                    <td style="width: 35%;">
                        <asp:DropDownList ID="tbCompName_D" CssClass="form-control text_md" runat="server" DataTextField="CompName" DataValueField="ID"></asp:DropDownList></td>
                </tr>
                <tr>
                    <td style="width: 15%;" class="text-right">公司部门：</td>
                    <td style="width: 35%;">
                        <asp:TextBox ID="tbPost_T" CssClass="form-control text_md" runat="server"></asp:TextBox></td>
                </tr>
            </table>
        </div>
