<%@ page language="C#" autoeventwireup="true" inherits="ZoomLaManage.WebSite.Manage.User.AdminManage, App_Web_j3oqy1go" title="管理员管理" tracemode="SortByCategory" enableviewstatemac="false" masterpagefile="~/Manage/I/Default.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
    ...
    <ZL:ExGridView ID="EGV" runat="server" AllowPaging="True" PageSize="20" AutoGenerateColumns="False" OnPreRender="EGV_PreRender"
        ...
        <Columns>
            ...
            <asp:TemplateField HeaderText="最近IP">
                <ItemTemplate>
                    <div class="td_m" style="overflow:hidden;"><%#Eval("LastLoginIP") %></div>
                </ItemTemplate>
            </asp:TemplateField>
            ...
            <asp:TemplateField HeaderText="操作" ItemStyle-HorizontalAlign="Center">
                <ItemTemplate>
                    ...
                    <a href="RegionManage.aspx?id=<%#Eval("AdminId") %>" title="设定管理员能查看哪些地区的订单" style="margin-right: 5px;" class="option_style"><i class="fa fa-key" title="权限"></i>区域订单权限</a>
                </ItemTemplate>
                <ItemStyle HorizontalAlign="Center" />
            </asp:TemplateField>
        </Columns>
