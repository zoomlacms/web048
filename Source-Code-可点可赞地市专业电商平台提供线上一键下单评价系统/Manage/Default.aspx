<%@ page language="C#" autoeventwireup="true" inherits="Manage_I_Default, App_Web_xzrho0dd" clientidmode="Static" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE html>
<html>
<head>
    ...
    <div class="m_top">
                        ...
                        <div class="col-lg-9 col-md-10 col-sm-9 col-xs-12 hidden-xs">
                            <div style="height: 42px;" class="m_top_menu row">
                                <ul class="list-unstyled ">
                                    ...
                                    <li class="menu10" onclick="openmenu('menu10')"><a onclick="showleft('menu10_1');" title="<%=Resources.L.移动 %>"><span class="visible-sm"><%=Resources.L.移动 %></span><span class="hidden-sm"><%=Resources.L.移动 %></span></a></li>
                        ...
                        <div class="col-lg-3 col-md-2 col-sm-3 col-xs-12 padding0 m_top_rl" style="padding-right: 20px;">
                            <div id="Announce">
                                <div class=" pull-right hidden-md hidden-sm hidden-xs">
                                    <a href="/" target="_blank" title="<%=Resources.L.返回首页 %>"><span class="glyphicon glyphicon-home"></span></a>
                                    <a href="/user/" target="_target" title="ALT+U<%=Resources.L.进入会员中心 %>"><span class="glyphicon glyphicon-user"></span></a>
                                    <a href="javascript:void(0)" style="cursor: pointer;" title='Alt+Q<%=Resources.L.锁定屏幕 %>' onclick="showWindow('Lockin.aspx',900,460);"><span class="glyphicon glyphicon-lock"></span>
                                        <a href="<%= CustomerPageAction.customPath2 %>SignOut.aspx" title="<%=Resources.L.退出 %>"><span class="glyphicon glyphicon-off"></span></a>
                                </div>
                                <div class="dropdown pull-right topdrop">
                                    ...
                                    <ul class="dropdown-menu" role="menu" aria-labelledby="dLabel">
                                        ...
                                        <li><a href="http://help.zoomla.cn/" target="_blank"><%=Resources.L.线上支持 %></a></li>
                                    </ul>
                                </div>
                            </div>
        ...
        <div class="m_top_bottom hidden-xs">
            ...
            <ul class="menu3">
                ...
                <li class="menu3_10"><a onclick="showleft('menu3_10','Flex/FlexTemplate.aspx')"><%=Resources.L.礼品管理 %></a></li>
                <li class="menu3_13">
                    <div class="btn-group topdrop">
            ...
            <ul class="menu9">
                ...
                <li class="menu9_3"><a onclick="showleft('menu9_3','AddOn/proejct/Projects.aspx')"><%=Resources.L.项目管理 %></a></li>
    ...
    <div class="m_main">
            ...
            <div id="left_ul_div">
                ...
                <div id="menu2" class="m_left_ul">
                    ...
                    <ul class="list-unstyled m_left_ulin" id="menu2_9">
                        <li class="bg-primary"><span class="fa fa-chevron-down"></span><%=Resources.L.百科问答 %></li>
                        <li>
                ...
                <div id="menu3" class="m_left_ul">
                    ...
                    <ul id="menu3_3" class="m_left_ulin">
                        ...
                        <li id="menu3_3_10"><a href="javascript:;" data-url="Shop/OtherOrder/IDCOrder.aspx?OrderType=7"><%=Resources.L.IDC订单 %></a></li>
                        <li id="menu3_3_18"><a href="javascript:;" data-url="Shop/OrderList.aspx?OrderType=9"><%=Resources.L.IDC续费 %></a></li>
                    ...
                    <ul id="menu3_7" class="m_left_ulin">
                        ...
                        <li id="menu3_7_7"><a href="javascript:;" data-url="Shop/ProductCashManage.aspx"><%=Resources.L.厂商提现 %></a></li>
            ...
            <ul class="list-unstyled">
                ...
                <!--<li id="menu3_12_4"><a href="javascript:;" data-url="Shop/profile/LmUserListTree.aspx">联盟会员树状图</a></li>-->
                    ...
                    <ul id="menu3_10" class="m_left_ulin">
                        <li class="menu_tit"><span class="fa fa-chevron-down"></span><%=Resources.L.礼品管理 %></li>
                        <li id="menu3_10_1"><a href="javascript:;" data-url="Flex/productManage.aspx"><%=Resources.L.产品管理 %></a></li>
                        <li id="menu3_10_2"><a href="javascript:;" data-url="Flex/Addproduct.aspx"><%=Resources.L.添加产品 %></a></li>
                        <li id="menu3_10_3"><a href="javascript:;" data-url="Flex/ClassManage.aspx"><%=Resources.L.模板分类管理 %></a></li>
                        <li id="menu3_10_4"><a href="javascript:;" data-url="Flex/Addclass.aspx"><%=Resources.L.添加模板分类 %></a></li>
                        <li id="menu3_10_5"><a href="javascript:;" data-url="Flex/FlexTemplate.aspx"><%=Resources.L.Flex礼品管理 %></a></li>
                        <li id="menu3_10_6"><a href="javascript:;" data-url="Flex/AddTemplate.aspx"><%=Resources.L.添加Flex礼品 %></a></li>
                        <li id="menu3_10_7"><a href="javascript:;" data-url="Flex/FlexItemManage.aspx"><%=Resources.L.礼品页面管理 %></a></li>
                        <li id="menu3_10_8"><a href="javascript:;" data-url="Flex/AddItempage.aspx"><%=Resources.L.添加礼品页面 %></a></li>
                    </ul>
		...
		<li id="menu6_7_12"><a href="javascript:;" data-url="Zone/SnsClassRoom.aspx"><%=Resources.L.班级管理%></a></li>--%>
                ...
                <div id="menu7" class="m_left_ul">
                    ...
                    <ul class="m_left_ulin" id="menu7_2">
                        ...
                        <li id="menu7_2_5"><a href="javascript:;" data-url="Panoramic/PanoramicManage.aspx"><%=Resources.L.全景列表%></a></li>
                        <li id="menu7_2_6"><a href="javascript:;" data-url="Panoramic/MusicManage.aspx"><%=Resources.L.全景音乐%></a></li>
                        <li id="menu7_2_7"><a href="javascript:;" data-url="AddOn/Maps.aspx"><%=Resources.L.地图管理%></a></li>
                        <li id="menu7_2_8"><a href="javascript:;" data-url="Magazine/AddMagazine.aspx"><%=Resources.L.电子杂志%></a></li>
                        <li id="menu7_2_9"><a href="javascript:;" data-url="/Plugins/Flex/Default.aspx"><%=Resources.L.在线设计%></a></li>
                        <li id="menu7_2_10"><a href="javascript:;" data-url="Flex/MyMaterial.aspx"><%=Resources.L.素材中心%></a></li>
                        <li id="menu7_2_11"><a href="javascript:;" data-url="Flex/MyWork.aspx"><%=Resources.L.我的作品%></a></li>
                    </ul>
                    ...
                    <ul class="m_left_ulin" id="menu7_9">
                        <li class="bg-primary"><span class="fa fa-chevron-down"></span><%=Resources.L.移动与微信%></li>
                        <li>
                ...
                <div id="menu8" class="m_left_ul">
                    ...
                    <ul class="m_left_ulin" id="menu8_6">
                        ...
                        <li id="menu8_6_5"><a href="javascript:;" data-url="Template/DSManage.aspx"><%=Resources.L.外部数据库源%></a></li>
                    </ul>
		...
		<li id="menu9_2_4"><a href="javascript:;" data-url="AddOn/StructAnalysis.aspx"><%=Resources.L.分析结构%></a></li>--%>
                    ...
                    <ul class="m_left_ulin" id="menu9_3">
                        ...
                        <li id="menu9_3_4"><a href="javascript:;" data-url="AddOn/Proejct/ProjectsType.aspx"><%=Resources.L.项目配置%></a></li>
                        <li id="menu9_3_1"><a href="javascript:;" data-url="AddOn/Proejct/ManageProjects.aspx"><%=Resources.L.项目管理%></a></li>
                        <li id="menu9_3_2"><a href="javascript:;" data-url="AddOn/proejct/ProjectRequireList.aspx"><%=Resources.L.需求管理%></a></li>
                        <li id="menu9_3_3"><a href="javascript:;" data-url="AddOn/proejct/WorkManage.aspx"><%=Resources.L.流程管理%></a></li>
                        <li id="menu9_3_5"><a href="javascript:;" data-url="AddOn/Proejct/ProjectsModelField.aspx"><%=Resources.L.项目模型%></a></li>
                    </ul>
                    <ul class="m_left_ulin" id="menu9_4" style="height: 700px; overflow: auto;">
                        ...
                        <%--<li id="menu9_4_2"><a href="javascript:;" data-url="AddCRM/CustomerList.aspx?usertype=2&modelid=49"><%=Resources.L.企业客户%></a></li>
		<li id="menu9_4_3"><a href="javascript:;" data-url="AddCRM/CustomerList.aspx?usertype=1&modelid=49"><%=Resources.L.个人客户%></a></li>
		<li><a href="javascript:" data-url="AddCRM/OptionManage.aspx"><%=Resources.L.选项管理%></a></li>     
		<li><a href="javascript:" data-url="AddCRM/CRMDictionary.aspx?FieldName=Complain_Type"><%=Resources.L.投诉记录表%></a></li>
		<li><a href="javascript:" data-url="AddCRM/CRMDictionary.aspx?FieldName=Service_Type"><%=Resources.L.服务记录表%></a></li>
		<li><a href="javascript:" data-url="AddCRM/CRMDictionary.aspx?FieldName=Client_Area"><%=Resources.L.客户区域%></a></li>
		<li><a href="javascript:" data-url="AddCRM/CRMDictionary.aspx?FieldName=Client_Calling" ><%=Resources.L.所属行业%></a></li>
		<li><a href="javascript:" data-url="AddCRM/CRMDictionary.aspx?FieldName=Client_Value"><%=Resources.L.价值评估%></a></li>
		<li><a href="javascript:" data-url="AddCRM/CRMDictionary.aspx?FieldName=Client_Credit"><%=Resources.L.信用等级%></a></li>
		<li><a href="javascript:" data-url="AddCRM/CRMDictionary.aspx?FieldName=Client_Importance"><%=Resources.L.重要程度%></a></li>
		<li><a href="javascript:" data-url="AddCRM/CRMDictionary.aspx?FieldName=Client_Connection"><%=Resources.L.关系等级%></a></li>
		<li><a href="javascript:" data-url="AddCRM/CRMDictionary.aspx?FieldName=Client_Group"><%=Resources.L.客户组别%></a></li>
		<li><a href="javascript:" data-url="AddCRM/CRMDictionary.aspx?FieldName=Client_Source"><%=Resources.L.客户来源%></a></li>
		<li><a href="javascript:" data-url="AddCRM/CRMDictionary.aspx?FieldName=Client_Phase" ><%=Resources.L.阶段%></a></li>
		<li><a href="javascript:" data-url="AddCRM/CRMDictionary.aspx?FieldName=Co_Status" ><%=Resources.L.行业地位%></a></li>
		<li><a href="javascript:" data-url="AddCRM/CRMDictionary.aspx?FieldName=Co_Size"><%=Resources.L.公司规模%></a></li>
		<li><a href="javascript:" data-url="AddCRM/CRMDictionary.aspx?FieldName=Co_Management" ><%=Resources.L.经营状态%></a></li>
		<li><a href="javascript:" data-url="AddCRM/CRMDictionary.aspx?FieldName=Complain_Type" ><%=Resources.L.服务类型%></a></li>
		<li><a href="javascript:" data-url="AddCRM/CRMDictionary.aspx?FieldName=Complain_Mode" ><%=Resources.L.服务方式%></a></li>
		<li><a href="javascript:" data-url="AddCRM/CRMDictionary.aspx?FieldName=Complain_Urgency" ><%=Resources.L.紧急程度%></a></li>                    
		<li><a href="javascript:" data-url="AddCRM/CRMDictionary.aspx?FieldName=Linkman_Income" ><%=Resources.L.月收入%></a></li>
		<li><a href="javascript:" data-url="AddCRM/CRMDictionary.aspx?FieldName=Linkman_Education"><%=Resources.L.学历%></a></li>
		<li><a href="javascript:" data-url="AddCRM/CRMDictionary.aspx?FieldName=Service_Type"><%=Resources.L.服务类型%></a></li>
		<li><a href="javascript:" data-url="AddCRM/CRMDictionary.aspx?FieldName=Service_Mode"><%=Resources.L.服务方式%></a></li>
		<li><a href="javascript:" data-url="AddCRM/CRMDictionary.aspx?FieldName=Service_TakeTime"><%=Resources.L.花费时间%></a></li>
		<li><a href="javascript:" data-url="AddCRM/CRMDictionary.aspx?FieldName=Service_Result"><%=Resources.L.服务结果%></a></li>
		<li><a href="javascript:" data-url="AddCRM/CRMDictionary.aspx?FieldName=Service_Score"><%=Resources.L.客户评价%></a></li>
		<li><a href="javascript:" data-url="AddCRM/CRMDictionary.aspx?FieldName=Time"><%=Resources.L.期限%></a></li>--%>
                    </ul>
                    ...
                    <ul class="m_left_ulin" id="menu9_9">
                        ...
                        <%--  <li id="menu9_9_2"><a href="javascript:;" data-url="Plat/PlatConfig.aspx"><%=Resources.L.能力配置%></a></li>--%>
                    </ul>
                ...
                <div id="menu10" class="m_left_ul">
                    <ul class="m_left_ulin open" id="menu10_1">
                        ...
                        <%--<li id="menu10_1_3"><a href="http://wei.zoomla.cn/" target="_blank"><%=Resources.L.移动模拟器%></a></li>--%>
                                    ...
                                    <div id="FrameTabs" style="overflow: hidden; width: 100%;">
                                        ...
                                        <div class="tab-strip-wrap">
                                            <ul class="tab-strip pull-left" id="tab_ul" style="position: fixed; background: #FFF;">
                                                <li class="current first" id="iFrameTab1"><a href="javascript:"><span id="frameTabTitle"><%=Resources.L.新选项卡%></span></a><a class="closeTab" title="关闭"><span class="glyphicon glyphicon-remove"></span></a></li>
                                                <li class="end" id="newFrameTab"><a title="<%=Resources.L.新选项卡%>" href="javascript:"><span class="glyphicon glyphicon-plus"></span></a></li>
                                            </ul>
                                            <div class="clearfix"></div>
                                        </div>
                                    </div>
