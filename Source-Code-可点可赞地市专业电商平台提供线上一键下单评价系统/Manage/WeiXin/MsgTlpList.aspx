<%@ page language="C#" autoeventwireup="true" inherits="Manage_WeiXin_MsgTlpList, App_Web_4fucw00k" masterpagefile="~/Manage/I/Default.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
        ...
        <Columns>
            ...
            <asp:TemplateField HeaderText="操作">
                <ItemTemplate>
                    ...
                    <asp:LinkButton runat="server" OnClientClick="return confirm('是否删除该项')" CommandName="Del" CommandArgument='<%#Eval("template_id") %>' CssClass="option_style"><span class="glyphicon glyphicon-trash" title="删除"></span> 删除</asp:LinkButton>
                </ItemTemplate>
            </asp:TemplateField>
        </Columns>
    </ZL:ExGridView>
