<%@ page language="C#" autoeventwireup="true" inherits="Manage_WeiXin_WelPage, App_Web_4fucw00k" masterpagefile="~/Manage/I/Default.master" validaterequest="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<asp:Content runat="server" ContentPlaceHolderID="Content">
    <table class="table table-bordered table-striped">
        ...
        <tr>
            <td>图片</td>
            <td>
                <asp:TextBox runat="server" ID="PicUrl_T" CssClass="form-control m715-50" placeholder="http://demo.zoomla.cn/pic.jpg" />
