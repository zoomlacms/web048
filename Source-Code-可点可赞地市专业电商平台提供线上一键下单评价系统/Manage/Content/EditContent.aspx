<%@ page language="C#" autoeventwireup="true" inherits="V_Content_EditContent, App_Web_zxpqkarz" masterpagefile="~/Manage/I/Default.master" clientidmode="Static" validaterequest="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<asp:Content ID="Content2" runat="server" ContentPlaceHolderID="Content">
    <div class="manage_content">
        ...
        <div class="tabbable">
            ...
            <div class="tab-content" style="margin-bottom: 40px;">
                ...
                <div class="tab-pane fade" id="InfoAttr">
                    <table class="table table-bordered table_padding0">
                        ...
                        <tr id="outpdf">
                            ...
                            <td>
                                <asp:LinkButton runat="server" ID="downPdfHref" ToolTip="点击下载" OnClick="downPdfBtn_Click" Visible="false"> <img src="/Plugins/ckfinder/skins/kama/images/icons/16/pdf.gif" class="content_d_img"/> </asp:LinkButton>
                        ...
                        <tr id="outword">
                            ...
                            <td>
                                <asp:LinkButton runat="server" ID="downWordHref" ToolTip="点击下载" OnClick="downWordBtn_Click" Visible="false"> <img src="/Plugins/Ueditor/themes/default/images/word.gif" class="content_d_img"/></asp:LinkButton>
                ...
                <div class="tab-pane fade" id="Copyright">
                    <table class="table table-bordered">
                        <tr>
                            <td class="fd_td_l td_l">授权规则</td>
                            <td>
                                <span style="float: left; margin: 5px 8px 0 5px;">
                                    <input id="rep_chk" class="hidden" type="checkbox" />转载使用</span>
                                <div class="text_md input-group" style="margin: 2px 0;">
                                    <ZL:TextBox ID="RepPri_T" runat="server" Text="0" class="form-control text_md" ValidType="FloatZeroPostive" />
                                    <span class="input-group-addon">元</span>
                                </div>
                                <span style="float: left; margin: 5px 8px 0 5px;">
                                    <input id="material_chk" class="hidden" type="checkbox" />素材使用</span>
                                <div class="text_md input-group" style="margin: 2px 0;">
                                    <ZL:TextBox ID="MatPri_T" runat="server" Text="0" class="form-control text_md" ValidType="FloatZeroPostive" />
                                    <span class="input-group-addon">元</span>
                                </div>
                            </td>
                        </tr>
                        <tr><td class="fd_td_l">版权号</td><td>
                        ...
                        <tr>
                            ...
                            <asp:ListItem Value="0" Selected="True">添加授权</asp:ListItem>
                            <asp:ListItem Value="1">暂停授权</asp:ListItem>
                            <asp:ListItem Value="2">添加为新授权</asp:ListItem>
                        </asp:RadioButtonList>--%>
                            </td>
                        </tr>
                    </table>
        ...
        <div class="Conent_fix">
            ...
            <a href="javascript:;" id="toTop" onclick="Control.Scroll.ToTop();"><i class="glyphicon glyphicon-upload"></i>Top</a>
...
<script>
    $(function () {Tlp_initTemp();crhelper.init();});
    //智能模板选择事件
