<%@ page language="C#" masterpagefile="~/Manage/I/Default.master" autoeventwireup="true" inherits="Manage_I_Content_ListHtmlContent, App_Web_zxpqkarz" clientidmode="Static" validaterequest="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
        ...
        <Columns>
            ...
            <asp:TemplateField HeaderText="<%$Resources:L,生成操作 %>">
                <ItemTemplate>
                    ...
                    <asp:LinkButton ID="LinkButton1" runat="server" CommandName="MakeHtml" CommandArgument='<%# Eval("GeneralID") %>' CausesValidation="false" CssClass="option_style"><i class="fa fa-spinner" title="<%=Resources.L.生成 %>"></i><%=Resources.L.生成文件 %></asp:LinkButton>
