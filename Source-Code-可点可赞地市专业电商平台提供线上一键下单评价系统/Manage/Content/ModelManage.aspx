<%@ page language="C#" masterpagefile="~/Manage/I/Default.master" autoeventwireup="true" inherits="Manage_I_Content_ModelManage, App_Web_zxpqkarz" enableEventValidation="false" viewStateEncryptionMode="Never" %>
        ...
        <Columns>
            <asp:TemplateField HeaderText="<%$Resources:L,操作 %>">
                ...
                <ItemTemplate>
                    ...
                    <li><asp:LinkButton runat="server" CssClass="option_style" CommandName="Field" CommandArgument='<%# Eval("ModelID") %>'><i class="glyphicon glyphicon-align-justify"></i><%=Resources.L.字段 %></asp:LinkButton></li>
                    <li><asp:LinkButton runat="server" CssClass="option_style" CommandName="Edit1" CommandArgument='<%# Eval("ModelID") %>'><i class="glyphicon glyphicon-pencil" title="<%=Resources.L.编辑 %>"></i><%=Resources.L.编辑 %></asp:LinkButton></li>
                    ...
                    <li><asp:LinkButton runat="server" CssClass="option_style" CommandName="Del2" CommandArgument='<%# Eval("ModelID") %>' OnClientClick="return confirm('确实要删除此模型吗？');"><i class="glyphicon glyphicon-trash"></i><%=Resources.L.删除 %></asp:LinkButton></li>                      
                    </ul>
                    </div>
                </ItemTemplate>
            </asp:TemplateField>
