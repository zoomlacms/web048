<%@ page language="C#" autoeventwireup="true" inherits="Manage_I_Content_EditNode, App_Web_zxpqkarz" masterpagefile="~/Manage/I/Default.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<%--                            <input type="button" class="btn btn-primary" style="margin-left:5px;" value="修改" onclick="$('#TxtNodeDir').removeAttr('disabled');" />--%>
                            ...
                            <ZL:ExGridView runat="server" ID="GroupAuth_EGV" AutoGenerateColumns="false" EnableTheming="False" CssClass="table table-striped table-bordered table-hover" DataKeyNames="GroupID">
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="查看">
                                        <HeaderStyle Width="7%" />
                                        <ItemTemplate>
                                            <asp:CheckBox ID="chkSel1" runat="server" Checked='<%#GroupAuth("look") %>' />
                                        </ItemTemplate>
                                        <ItemStyle HorizontalAlign="Center" />
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="下载">
                                        <HeaderStyle Width="7%" />
                                        <ItemTemplate>
                                            <asp:CheckBox ID="chkSel11" runat="server" Checked='<%#GroupAuth("down") %>' />
                                        </ItemTemplate>
                                        <ItemStyle HorizontalAlign="Center" />
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="引用">
                                        <HeaderStyle Width="7%" />
                                        <ItemTemplate>
                                            <asp:CheckBox ID="chkSel12" runat="server" Checked='<%#GroupAuth("quote") %>' />
                                        </ItemTemplate>
                                        <ItemStyle HorizontalAlign="Center" />
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="录入">
                                        <HeaderStyle Width="7%" />
                                        <ItemTemplate>
                                            <asp:CheckBox ID="chkSel2" runat="server" Checked='<%#GroupAuth("addTo") %>' />
                                        </ItemTemplate>
                                        <ItemStyle HorizontalAlign="Center" />
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="修改">
                                        <HeaderStyle Width="7%" />
                                        <ItemTemplate>
                                            <asp:CheckBox ID="chkSel3" runat="server" Checked='<%#GroupAuth("Modify") %>' />
                                        </ItemTemplate>
                                        <ItemStyle HorizontalAlign="Center" />
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="删除">
                                        <HeaderStyle Width="7%" />
                                        <ItemTemplate>
                                            <asp:CheckBox ID="chkSel4" runat="server" Checked='<%#GroupAuth("Deleted") %>' />
                                        </ItemTemplate>
                                        <ItemStyle HorizontalAlign="Center" />
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="仅当前节点">
                                        <HeaderStyle Width="15%" />
                                        <ItemTemplate>
                                            <asp:CheckBox ID="chkSel5" runat="server" Checked='<%#GroupAuth("Columns") %>' />
                                        </ItemTemplate>
                                        <ItemStyle HorizontalAlign="Center" />
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="评论管理">
                                        <ItemTemplate>
                                            <asp:CheckBox ID="chkSel6" runat="server" Checked='<%#GroupAuth("Comments") %>' />
                                        </ItemTemplate>
                                        <ItemStyle HorizontalAlign="Center" />
                                    </asp:TemplateField>
                                </Columns>
        ...
        <div class="panel-footer text-center" style="border-bottom:1px solid #ddd;">
            <asp:Button ID="EBtnSubmit" CssClass="btn btn-primary" Text="保存" OnClick="EBtnSubmit_Click" runat="server" UseSubmitBehavior="false" />
