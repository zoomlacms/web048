<%@ page language="C#" autoeventwireup="true" inherits="Manage_I_Content_ContentManage, App_Web_zxpqkarz" masterpagefile="~/Manage/I/Default.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<div id="timeReDiv" style="display:none;" class="margin_t10">
	<table class="table table-bordered">
		...
		<tr>
			...
			<td>
				<asp:Button runat="server" ID="timeReConfBtn" OnClick="timeReConfBtn_Click" OnClientClick="return scheCheck();" CssClass="btn btn-primary" Text="<%$Resources:L,添加任务 %>" CausesValidation="false" />
