<%@ page language="C#" autoeventwireup="true" inherits="V_Content_AddContent, App_Web_zxpqkarz" masterpagefile="~/Manage/I/Default.master" clientidmode="Static" validaterequest="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<asp:Content ID="Content1" runat="server" ContentPlaceHolderID="head">
    <title>
        <asp:Literal runat="server" ID="Title_L"></asp:Literal></title>
...
<asp:Content runat="server" ContentPlaceHolderID="Content">
    <div class="manage_content">
                        ...
                        <tr id="attPic" runat="server">
                            ...
                            <td style="height: 80px;">
                               ...
                               <%-- <select name="selectpic" id="selectpic" onchange="ShowPic(this.value)" class="form-control text_300">
                                    <option value="" selected="selected"><%=Resources.L.不指定附属图片 %></option>
                                </select>--%>
        ...
        <div id="pushcon_div" class="alert alert-info">
            <div><%=Resources.L.保存时自动推送 %><a href="javascript:$('#pushcon_div').hide();;" title='<%=Resources.L.隐藏 %>'><span class="glyphicon glyphicon-remove"></span></a></div>
