<%@ page language="C#" masterpagefile="~/Manage/I/Default.master" autoeventwireup="true" inherits="Manage_I_Content_CreateHtmlContent, App_Web_zxpqkarz" clientidmode="Static" validaterequest="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
  ...
  <div>
    ...
    <div class="tab-content">
      <div class="tab-pane active" id="Tab1">
            ...
            <td class="text-right"><%=Resources.L.发布最新内容 %>： </td>
              <td>
                  <div class="input-group" style="width: 300px;">
                      ...
                      <asp:TextBox ID="txtNewsCount" CssClass="form-control text_md num" runat="server" placeholder="<%$Resources:L,请输入数量 %>"></asp:TextBox>
                      <span class="input-group-btn">
        ...
        <%--  <tr>
            <td class="text-right"><%=Resources.L.发布人才系统 %>： </td>
            <td><asp:DropDownList ID="DropDownList1" CssClass="form-control pull-left" Width="150" runat="server">
                <asp:ListItem Value="zhaopin" Text="<%$Resources:L,招聘企业 %>"></asp:ListItem>
                <asp:ListItem Value="zhiwei" Text="<%$Resources:L,职位信息 %>"></asp:ListItem>
                <asp:ListItem Value="jianli" Text="<%$Resources:L,用户简历 %>"></asp:ListItem>
              </asp:DropDownList>
              <asp:Button ID="Button4" runat="server" Style="margin-left: 10px;" Text="<%$Resources:L,开始发布 %>" CssClass="btn btn-primary" OnClick="Button4_Click" /></td>
          </tr>--%>
          <tr>
      ...
      <div class="tab-pane" id="Tab4">
          <table class="table table-striped table-bordered table-hover">
                <tr class="text-center"><td colspan="4"><strong><%=Resources.L.发布单页 %></strong></td></tr>
	            <tr>
