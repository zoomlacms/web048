<%@ page language="C#" autoeventwireup="true" inherits="Manage_WorkFlow_AddMisModel, App_Web_z4i0svxo" masterpagefile="~/Manage/I/Default.master" validaterequest="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
        ...
        <table class="table table-striped table-bordered table-hover">
            ...
            <tr>
                ...
                <td>
                    ...
                    <ZL:FileUpload runat="server" ID="Word_UP" style="display:inline-block;" AccessKey="doc,docx" />
