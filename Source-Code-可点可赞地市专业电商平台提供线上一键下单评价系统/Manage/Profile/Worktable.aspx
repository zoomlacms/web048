<%@ page language="C#" autoeventwireup="true" inherits="ZoomLa_WebSite_Manages_Worktable, App_Web_3zbjoayo" masterpagefile="~/Common/Master/Empty.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<div class="panel panel-info Worktable_well">
    ...
    <div class="panel-body">
        <ul class="link_menu" style="list-style-type: none;">
            ...
            <li class="litd"><a href="../Template/TemplateSet.aspx"><i class="fa fa-cubes"></i><br /><a href="../Template/TemplateSet.aspx" target="_self"><%=Resources.L.模板设置 %></a></li>
...
<div class="row padding_l_r10px">
    ...
    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12 padding5">
        <div class="panel panel-default Worktable_well">
            <div class="panel-heading"><i class="fa  fa-shopping-cart"></i><span> <%=Resources.L.商城管理 %></span><span class="badge pull-right"><a href="javascript:;" title="<%=Resources.L.商城管理 %>" onclick="ShowMain('ShopNodeTree.ascx','Shop/ProductManage.aspx');">More</a></span></div>
            <div class="panel-body WorktableHeight"><div id="chart2" class="zlchart"></div></div>
        </div>
    </div>
    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12 padding5">
        <div class="panel panel-default Worktable_well">
    ...
    <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 padding5">
        <div class="panel panel-default">
            ...
            <div class="panel-footer">
                <a href="http://www.zoomla.cn/help/web/1414.shtml" class="margin-15 hidden-xs" title="<%=Resources.L.设置Cookie %>" target="_blank"><%=Resources.L.设置Cookie %></a>
                <a href="http://www.zoomla.cn/help/web/1413.shtml" class="margin-15 hidden-xs hidden-sm" title="<%=Resources.L.设置网页脚本 %>" target="_blank"><%=Resources.L.设置网页脚本 %></a>
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body sche" style="padding:0px;height:240px;">
                <table class="table table-bordered table-striped">
                    <tr><td>任务ID</td><td>任务名称</td><td>执行计划</td><td>结果</td></tr>
                    <asp:Repeater runat="server" ID="Sche_RPT" EnableViewState="false">
                        <ItemTemplate>
                            <tr><td><%#Eval("TaskName") %></td>
