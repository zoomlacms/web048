<%@ page language="C#" autoeventwireup="true" inherits="Manage_I_Config_AppConfig, App_Web_pxrwdi1a" masterpagefile="~/Manage/I/Default.master" enableviewstatemac="false" clientidmode="AutoID" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<asp:Content runat="server" ContentPlaceHolderID="Content">
    ...
    <table class="table table-striped table-bordered table-hover tab-content"">
        ...
        <tr>
            ...
            <td>
                <asp:CheckBox ID="CheckBox1" runat="server" />点击启动重系统请慎重!
            </td>
        </tr>
        <tr>
