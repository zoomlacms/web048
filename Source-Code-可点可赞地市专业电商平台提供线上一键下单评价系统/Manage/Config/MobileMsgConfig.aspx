<%@ page language="C#" autoeventwireup="true" inherits="Manage_I_Config_MobileMsgConfig, App_Web_pxrwdi1a" masterpagefile="~/Manage/I/Default.master" enableviewstatemac="false" validaterequest="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<tr>
    ...
    <td>
        <asp:TextBox ID="MaxPhoneMsg" runat="server" Text="10" CssClass="form-control text_s num"/>
    </td>
</tr>
<tr>
    <td><strong>每日ip发送次数：</strong></td>
    <td>
        <asp:TextBox ID="MaxIpMsg" runat="server" Text="50" CssClass="form-control text_s num"/>
    </td>
</tr>
<tr>
