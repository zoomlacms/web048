<%@ page language="C#" autoeventwireup="true" inherits="Manage_I_Config_ThumbConfig, App_Web_pxrwdi1a" masterpagefile="~/Manage/I/Default.master" enableviewstatemac="false" validaterequest="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<td><div><img id="iLogo_img" class="preview_img" style="max-width:110px;max-height:110px;" onerror="this.src='/Images/nopic.gif';"/><div class="file-panel" style="height: 0px;"><span class="editpic" title="编辑"></span><span class="cancel" title="删除"></span></div></div>
    <asp:TextBox runat="server" id="iLogo_url" type="text" class="form-control text_300 margin_t5"/></td>
</tr>
<tr>
<td>编图水印：
</td>
