<%@ page language="C#" autoeventwireup="true" inherits="manage_Config_EditDataList, App_Web_pxrwdi1a" enableviewstatemac="false" masterpagefile="~/Manage/I/Default.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
    ...
    <div id="BreadDiv" class="container-fluid mysite" style="margin-bottom:10px;">
        ...
        <%--            [<span class="line"><a href="ViewList.aspx" style="color: red;">视图概况</a></span>]--%>
				...
				<div class="pull-right" style="padding-top:5px;">
                    <div id="help"><a href="javascript:;" id="sel_btn" class="help_btn"><i class="glyphicon glyphicon-search"></i></a><a onclick="help_show('68')" title="帮助" class="help_btn"><i class="glyphicon glyphicon-question-sign"></i></a></div>
                    <div id="sel_box">
