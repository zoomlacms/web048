<%@ page language="C#" autoeventwireup="true" enableeventvalidation="false" inherits="ZoomLa.WebSite.Manage.Config.UserConfig, App_Web_pxrwdi1a" validaterequest="false" enableviewstatemac="false" masterpagefile="~/Manage/I/Default.master" viewStateEncryptionMode="Never" %>
    ...
    <div class="tab-content panel-body padding0">
        ...
        <div class="tab-pane" id="Tabs1">
            <table class="table table-striped table-bordered table-hover myform-control">
	          ...
	          <asp:RegularExpressionValidator ID="ValgTxtPresentMoney" runat="server" ControlToValidate="TxtPresentMoney"
                ...
                <tr id="#save">
                    <td class="text-center" colspan="2">
                        <asp:Button ID="Button10" runat="server" Text="保存设置" OnClick="Button1_Click" class="btn btn-primary" />
                    </td>
                </tr>
            </table>
        </div>
        <div class="tab-pane" id="Tabs2">
            <table class="table table-striped table-bordered myform-control">
	          ...
	          <asp:RegularExpressionValidator ID="RegularExpressionValidator5" runat="server" ControlToValidate="TxtCUserExpExchangeExp"
                ...
                <tr id="#save">
                    <td class="text-center" colspan="2">
                        <asp:Button ID="Button11" runat="server" Text="保存设置" OnClick="Button1_Click" class="btn btn-primary" />
                    </td>
                </tr>
            </table>
        </div>
        <div class="tab-pane" id="Tabs3">
            <table class="table table-striped table-bordered table-hover myform-control">
	          ...
	          <asp:RegularExpressionValidator ID="ValgPresentPoint" runat="server" ControlToValidate="TxtPresentPoint"
                ...
                <tr id="#save">
                    <td class="text-center" colspan="2">
                        <asp:Button ID="Button12" runat="server" Text="保存设置" OnClick="Button1_Click" class="btn btn-primary" />
                    </td>
                </tr>
            </table>
        </div>
        <div class="tab-pane" id="Tabs4">
            <table class="table table-striped table-bordered table-hover myform-control">
                ...
                <tr id="#save">
                    <td class="text-center" colspan="2">
                        <asp:Button ID="Button13" runat="server" Text="保存设置" OnClick="Button1_Click" class="btn btn-primary" />
                    </td>
                </tr>
            </table>
        </div>
        <div class="tab-pane" id="Tabs5">
            <table class="table table-striped table-bordered table-hover myform-control">
                ...
                <tr id="#save">
                    <td class="text-center" colspan="2">
                        <asp:Button ID="Button14" runat="server" Text="保存设置" OnClick="Button1_Click" class="btn btn-primary" />
                    </td>
                </tr>
            </table>
        </div>
