<%@ page language="C#" autoeventwireup="true" inherits="Manage_I_Config_SiteOption, App_Web_pxrwdi1a" masterpagefile="~/Manage/I/Default.master" enableviewstatemac="false" validaterequest="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<table class="table table-striped table-bordered table-hover">
	<tbody>
		...
		<tr>
			...
			<td>
				...
				<asp:Button runat="server" ID="IsOpenHelp_Btn" style="display:none;" OnClick="IsOpenHelp_SelectedIndexChanged" />
					...
					<span id="PromptHelp" runat="server">(<a id="PromptHelps" runat="server" href="http://update.zoomla.cn/help.rar" style="color: Blue;" target="_blank"><%=Resources.L.下载离线帮助包 %></a>)</span>
			</td>
		</tr>
		<tr>
		...
		<tr>
			<td ><strong><%=Resources.L.站长拥有资金 %>：</strong></td>
			<td>
		...
		<!--原短消息提示已无用-->
		<%--<tr>
			<td style="width: 200px;"><strong><%=Resources.L.短消息提示 %>：</strong></td>
			<td style="padding-left: 8px;">
	...
	<tbody>
		...
		<tr>
			...
			<td>
				...
				<span class="rspan"><%=Resources.L.支持从远程云端下载功能与模板界面 %>，<%=Resources.L.官方服务器地址 %>：http://update.zoomla.cn</span></td>
		</tr>
		<tr>
...
<table class="table table-striped table-bordered table-hover">
	<tbody>
        ...
        <tr>
            <td><strong><%=Resources.L.订单确认后才可付款 %>：</strong></td>
		...
		<tr>
			...
			<td>
				<span id="Api" runat="server">
					...
					<span><%=Resources.L.提示 %>：<%=Resources.L.用于商城网店查询订单 %>，<a href="http://www.kuaidi100.com/openapi/" target="_blank" style="color: #f00; text-decoration: underline;"><%=Resources.L.点此申请快递100集成密钥 %></a>。</span>
				</span>
