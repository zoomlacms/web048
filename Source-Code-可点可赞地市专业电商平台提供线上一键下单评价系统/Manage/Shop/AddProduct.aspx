<%@ page language="C#" autoeventwireup="true" validaterequest="false" enableeventvalidation="false" inherits="Zoomla.Website.manage.Shop.AddProduct, App_Web_nyhcbgu4" enableviewstatemac="false" masterpagefile="~/Manage/I/Default.master" viewStateEncryptionMode="Never" %>
        ...
        <table class="table table-striped table-bordered">
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:TextBox ID="ProCode" runat="server" class="form-control text_md" /></td>
                    </tr>
                    <tr>
                        <td><strong>条形码：</strong></td>
                        <td>
                            <asp:TextBox ID="BarCode" runat="server" class="form-control text_300 num" /></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:TextBox ID="Kayword" runat="server" class="form-control text_300" /></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <table id="bindpro_table" style="display: none;" class="table table-striped table-bordered">
                                ...
                                <tr>
                                    <td colspan="5">
                                        <input type="button" class="btn btn-primary" value="移除选定捆绑" onclick="RemoveBind();" /></td>
                                </tr>
                            </table>
                        </td>
                    </tr>
                                    ...
                                    <asp:View ID="View1" runat="server">
                                        <table id="tgTable" class="classdiv">
                                            ...
                                            <tr>
                                                <td>最低团购人数：</td>
                                                <td>
                                                    <asp:TextBox ID="NumberText" runat="server" class="form-control text_s" /><span>人</span></td>
                                                <td>团购价格:</td>
                                                <td>
                                                    <asp:TextBox ID="TGPrice" runat="server" class="form-control text_s" /></td>
                                            </tr>
                                            <tr>
                                                <td>开始时间</td>
                                                <td>
                                                    <asp:TextBox ID="ColonelStartTimetxt" runat="server" onclick="WdatePicker({ dateFmt: 'yyyy/MM/dd HH:mm:ss' });" class="form-control" /></td>
                                                <td>结束时间:</td>
                                                <td>
                    ...
                    <tr><td><strong>区域价格:</strong></td><td>
                        <div class="input-group text_405">
                            ...
                            <span class="input-group-btn">
                                ...
                                <button class="btn btn-primary" type="button" onclick="region.add()">设置多区域价格</button>
                            </span>
                        </div>
...
<%--                            <div class="text_md input-group">
                    ...
                    <tr>
                        ...
                        <td>购买<asp:TextBox ID="IntegralNum" runat="server" Text="1" class="form-control text_xs" />
