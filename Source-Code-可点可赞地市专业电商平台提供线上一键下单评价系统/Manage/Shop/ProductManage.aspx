<%@ page language="C#" autoeventwireup="true" inherits="Zoomla.Website.manage.Shop.ProductManage, App_Web_nyhcbgu4" masterpagefile="~/Manage/I/Default.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<ol id="BreadNav" class="breadcrumb navbar-fixed-top">
    ...
    <div class="pull-right hidden-xs" style="padding-right: 10px;">
            <span><a href="/Class_<%:NodeID<=0?2:NodeID %>/Default.aspx" target="_blank" title="<%=Resources.L.前台浏览 %>"><span class="glyphicon glyphicon-eye-open"></span></a>
                <span onclick="opentitle('<%:NodeID %>','<%=Resources.L.配置本节点 %>');" class="glyphicon glyphicon-cog" title="<%=Resources.L.配置本节点 %>" style="cursor: pointer; margin-left: 5px;"></span></span></div>
</ol>
    ...
    <script type="text/javascript">
       ...
       <div id="divImp" class="divline">
           ...
           <%--<asp:FileUpload ID="FileUpload1" runat="server" style="display:inline;"/>--%>
            ...
            <span style="color:#0E529D;"><%=Resources.L.下载 %><asp:Label runat="server" ID="NodeName_L1"></asp:Label> 的<asp:Label runat="server" ID="Item_L1"></asp:Label> <%=Resources.L.模型CSV导入模板 %></span>
