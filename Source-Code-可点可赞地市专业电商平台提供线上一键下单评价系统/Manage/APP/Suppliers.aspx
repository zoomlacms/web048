<%@ page language="C#" autoeventwireup="true" inherits="manage_APP_Suppliers, App_Web_iwbkhbm5" enableviewstatemac="false" masterpagefile="~/Manage/I/Default.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
    ...
    <div class="tab-content">
        <div role="tabpanel" class="tab-pane active" id="app">
            <table class="table table-striped table-bordered">
                <tr>
                    <td class="td_l">
                        <img style="cursor: pointer;" src="/App_Themes/Admin/Sina_2.png" /></td>
                    <td>
                ...
                <tr>
                    <td>
                        <img style="cursor: pointer;" src="/App_Themes/Admin/QQ_2.png" /></td>
                    <td>
                        <div class="input-group margin_b2px">
                ...
                <tr>
                    <td>
                        <img style="cursor: pointer;" src="/App_Themes/Admin/Baidu_2.png" /></td>
                    <td>
                        <div class="input-group margin_b2px">
                            <span class="input-group-addon">Key</span>
