<%@ page language="C#" autoeventwireup="true" inherits="User_Questions_ExamDetail, App_Web_nt45m0ea" enableviewstatemac="false" masterpagefile="~/Common/Common.master" validaterequest="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<asp:Content runat="server" ContentPlaceHolderID="Content">
    <div class="panel panel-primary"  ng-app="app">
        <div class="panel-heading navbar-fixed-top" id="quelist"><i class="fa fa-file-text-o"></i>
            ...
            <span><i class="glyphicon glyphicon-time"></i><span id="time_sp" class="margin_l5" runat="server" data-time="0"></span></span>
