<%@ page title="" language="C#" masterpagefile="~/User/Default.master" autoeventwireup="true" inherits="User_Content_CommentList, App_Web_el05aryi" clientidmode="Static" enableEventValidation="false" viewStateEncryptionMode="Never" %>
            ...
            <ItemTemplate>
                <div class="div_bot">
                    <div class="SideBar">
                        ...
                        <asp:CheckBox ID="chkSel" Checked="false" runat="server" Visible='<%# IsHimself(Eval("UserID")) %>' />评论人：<%# GetUserName(Eval("UserID","{0}")) %>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;评论意见：<span><%# GetPK(Eval("PKS","{0}")) %></span>
                    </div>
                    <div class="ListText">
                        <%# Eval("Contents")%>
                    </div>
