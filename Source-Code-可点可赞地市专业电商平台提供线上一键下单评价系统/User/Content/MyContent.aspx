<%@ page language="C#" masterpagefile="~/User/Default.master" autoeventwireup="true" inherits="ZoomLa.WebSite.User.Content.MyContentpage, App_Web_u2jnd3d4" enableEventValidation="false" viewStateEncryptionMode="Never" %>
                        ...
                        <asp:TemplateField HeaderText="操作" HeaderStyle-CssClass="td_l">
                            <ItemTemplate>
                                ...
                                <asp:LinkButton runat="server" CssClass="option_style" CommandName="edit" CommandArgument='<%# Eval("GeneralID") %>'
                                    Visible='<%#GetIsNRe(Eval("Status", "{0}"),"edit") %>' ToolTip="修改"><i class="glyphicon glyphicon-pencil"></i></asp:LinkButton>
                                <asp:LinkButton runat="server" CssClass="option_style" CommandName="view" CommandArgument='<%# Eval("GeneralID") %>' 
                                    Visible='<%#GetIsNRe(Eval("Status", "{0}"),"view") %>' ToolTip="预览"><i class="glyphicon glyphicon-globe"></i>预览</asp:LinkButton>
