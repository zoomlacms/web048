<%@ page language="C#" autoeventwireup="true" inherits="User_ChangeMP, App_Web_azpey0zz" enableviewstatemac="false" masterpagefile="~/User/Default.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
        ...
        <asp:Panel ID="step2_div" runat="server" Visible="false">
            <table class="table table-bordered table-striped">
                <tr>
                    ...
                    <td>
                        <asp:TextBox ID="NewMobile_T" runat="server" CssClass="form-control text_300" />
