<%@ page title="" language="C#" masterpagefile="~/User/Default.master" autoeventwireup="true" inherits="User_UserShop_Default, App_Web_rpyoed12" clientidmode="Static" validaterequest="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<li class="active">店铺主页 <asp:Label runat="server" id="StoreUrl_L"></asp:Label></li>
</ol>
</div>
<div class="container">
...
<script>
    $(function () { $("input[type=text]").addClass("form-control text_md"); })
