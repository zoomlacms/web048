<%@ page language="C#" autoeventwireup="true" inherits="User_Exam_QuestRPT, App_Web_1crxgxls" enableviewstate="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<start>
    ...
    <div runat="server" id="login_div" visible="false" class="alert alert-danger">你当前是[<span style="color:red;">游客</span>]身份,登录后可以启用更多功能!<a href="/User/Login.aspx?ReturnUrl=/User/Exam/QuestionManage.aspx">点击登录</a></div>
