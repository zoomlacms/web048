<%@ page language="C#" autoeventwireup="true" inherits="ZoomLa.WebSite.User.User_Register, App_Web_1e4sohw2" clientidmode="Static" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<div class="reg_sub_t" onclick="SwicthSelectFill();" id="disable_btn" style="cursor: pointer;"><i class="glyphicon glyphicon-grain"></i>选填信息</div>
<ul class="list-unstyled">
<li>
...
<div>
<asp:CheckBox ID="CheckBox1" runat="server" Text=" 同意并接受注册协议" Checked="true" onclick="checkreg(this)" Style="color: #fff;" />
...
<div class="reg">
<h1 class="text-center"><span class="glyphicon glyphicon-user" style="font-size: 2em; margin-right: 10px; color: #00CCFF;"></span><span class="margin_l5">会员帐号信息</span></h1>
<ul id="userinfo">
<li>
...
<li><a href="/User/Default.aspx" class="btn btn-primary">进入用户中心</a></li>
</ul>
</div>
<div class="clearfix"></div>
</asp:Panel>
