<%@ page language="C#" autoeventwireup="true" inherits="User_Default, App_Web_1e4sohw2" clientidmode="Static" enableEventValidation="false" viewStateEncryptionMode="Never" %><!DOCTYPE html>
...
<li>
<ul class="list-unstyled">
<li><i class="glyphicon glyphicon-usd"></i>余额：<a href="info/ConsumeDetail.aspx?SType=1" title="点击查看资金明细"><asp:Label ID="UserYeLb" runat="server" Text=""></asp:Label></a>
