<%@ page title="" language="C#" masterpagefile="~/User/Default.master" autoeventwireup="true" inherits="User_Info_DredgeVip, App_Web_qgr2pzqu" clientidmode="Static" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<asp:View ID="View1" runat="server">
    <div class="panel panel-info" style="width:500px;margin:0 auto;margin-top:5px;">
        <div class="panel-heading"><i class="fa fa-credit-card-alt"></i> VIP信息</div>
