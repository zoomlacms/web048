<%@ page language="C#" autoeventwireup="true" inherits="User_UserZone_SetCenter_SC_WhoCallme, App_Web_nd1kceyd" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<div class="us_pynews">
<a title="会员中心" href='<%=ResolveUrl("~/User/Default.aspx")%>' target="_parent">会员中心</a>&gt;&gt;设置中心&gt;&gt;谁能联系我（V） 
</div>
</div>
