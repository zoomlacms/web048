<%@ page title="" language="C#" masterpagefile="~/User/Default.master" autoeventwireup="true" inherits="ZoomLa.WebSite.User.UserZone.Pic.UpPic, App_Web_wnkrrgpc" clientidmode="Static" enableEventValidation="false" viewStateEncryptionMode="Never" %>
                ...
                <table class="table table-bordered table-hover table-striped">
                    <tr>
                        <td rowspan="2">你可以上传JPG，JPEG，<br />
                            ...
                            每个文件大小可以到3M。 </td>
                        <td>
                            <ZL:FileUpload ID="UpPic1" runat="server" />
                            <%--<input id="UpPic1" type="file" runat="server" />--%></td>
                    </tr>
                    <tr>
                        <td><ZL:FileUpload ID="UpPic2" runat="server" />
                    ...
                    <tr>
                        <td rowspan="3">你需要对你上传的内容负责，<br />
                            ...
                            隐私、色情、暴力血腥及违反<br />
                            国家法律法规的照片或图片。 </td>
                        <td><ZL:FileUpload ID="UpPic3" runat="server" />
                            <%--<input id="UpPic3" type="file" runat="server" />--%>
                        </td>
                    </tr>
                    <tr>
                        <td><ZL:FileUpload ID="UpPic4" runat="server" />
                            <%--<input id="UpPic4" type="file" runat="server" />--%>
                        </td>
                    </tr>
                    <tr>
                        <td><ZL:FileUpload ID="UpPic5" runat="server" />
